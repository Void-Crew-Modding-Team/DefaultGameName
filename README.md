...
### 💡 Function - Changes the default game name

### 🎮 Client Usage

- Install
- Configure at F5 > Mod Settings > Default Game Name

### 👥 Multiplayer Functionality

- ✅ Client
  - This does not negatively impact other players
...
Drag and drop `DefaultGameName.dll` into `Void Crew\BepInEx\plugins`
